...
/*============================================================================
 *
 * Purpose : Algorithm for RSA_OAEP with SHA224
 *
 *==========================================================================*/
#ifndef _UCL_RSA_ES_OAEP_SHA224_H_
#define _UCL_RSA_ES_OAEP_SHA224_H_
...
/** @file ucl_pkcs1_es_oaep_sha224.h
 * @defgroup UCL_PKCS1V21_OAEP_SHA224 RSA OAEP SHA224
 * Encrypt/Decrypt with RSA OAEP using the hash function SHA224.
 *
 * @par Header:
 * @link ucl_pkcs1_es_oaep_sha224.h ucl_pkcs1_es_oaep_sha224.h @endlink
 *
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA224 encryption</b>.
 * Encryption complete process using the hash function SHA224.
 *
 ...
 * @see UCL_SHA224
 *
 * @ingroup UCL_PKCS1V21_OAEP_SHA224
 */
int ucl_pkcs1_es_oaep_sha224_encrypt(u8 *output, u8 *input,
                                     u32 input_length, 
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA224 decryption</b>.
 * Decryption complete process using the hash function SHA224.
 *
 ...
 * @ingroup UCL_PKCS1V21_OAEP_SHA224
 */
int ucl_pkcs1_es_oaep_sha224_decrypt(u8 *output, u32 *output_length,
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA224 decryption with CRT</b>.
 * Decryption with CRT complete process using the hash function SHA224.
 *
 * @param[out] output                Pointer to decrypted message
 ...
 * @ingroup UCL_PKCS1V21_OAEP_SHA224
 */
int ucl_pkcs1_es_oaep_sha224_crt_decrypt(u8 *output, u32 *output_length, 
                                         u8 *input, 
...
#endif /* _UCL_RSA_ES_OAEP_SHA224_H_ */
