...
#define CKR_FIPS_TEMPLATE_INCONSISTENT \
    (CKR_VENDOR_DEFINED | CKR_TEMPLATE_INCONSISTENT)
#define CKR_FIPS_MECHANISM_INVALID \
    (CKR_VENDOR_DEFINED | CKR_MECHANISM_INVALID)

/* We need a FIPS authorization token from a cardset,
   even if generating module protected keys on a module slot */
#define CKR_FIPS_TOKEN_NOT_PRESENT \
    (CKR_VENDOR_DEFINED | CKR_TOKEN_NOT_PRESENT)

#define CKR_FIPS_FUNCTION_NOT_SUPPORTED \
    (CKR_VENDOR_DEFINED | CKR_FUNCTION_NOT_SUPPORTED)
