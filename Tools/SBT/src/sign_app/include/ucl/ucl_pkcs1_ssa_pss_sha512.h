 ...
 */
  ...
  int ucl_pkcs1_ssa_pss_sha512_verify_digest(u8 *signature, u8 *hash, u32 hash_length, ucl_rsa_public_key_t *keyPu, u32 salt_length);
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_SHA512
 */
int ucl_pkcs1_ssa_pss_sha512_verify(u8 *signature, u8 *message, u32 message_length, ucl_rsa_public_key_t *keyPu, u32 salt_length);
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_SHA512
 */
  int __API__ ucl_pkcs1_ssa_pss_sha512_verify_(u8 *signature, u8 *message, u32 message_length, ucl_rsa_public_key_t *keyPu, u32 salt_length,int is_digest);
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_SHA512
 */
int ucl_pkcs1_ssa_pss_sha512_sign(u8 *signature, u8 *message, u32 message_length, ucl_rsa_private_key_t *keyPr, u32 salt_length);
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_SHA512
 */
int ucl_pkcs1_ssa_pss_sha512_hashed_sign(u8 *signature, u8 *message, u32 message_length, ucl_rsa_private_key_t *keyPr, u32 salt_length);
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_SHA512
 */
int ucl_pkcs1_ssa_pss_sha512_crt_sign(u8 *signature, u8 *message, u32 message_length, ucl_rsa_crt_private_key_t *key, u32 salt_length);
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_SHA512
 */
int ucl_pkcs1_ssa_pss_sha512_hashed_crt_sign(u8 *signature, u8 *message, u32 message_length, ucl_rsa_crt_private_key_t *key, u32 salt_length);
