 ...
 * the SM4, see http://www1.cnnic.cn/ScientificResearch/LeadingEdge/soea/sm4/201312/t20131204_43351.htm
 *
 * @par Header:
...
int sm4_crypt_ecb( sm4_context *ctx, int mode, int length, unsigned char *input, unsigned char *output);
 ...
 * @ingroup UCL_SM4
 */
int sm4_crypt_cbc( sm4_context *ctx, int mode, int length, unsigned char iv[16], unsigned char *input, unsigned char *output );
