...
/*============================================================================
 *
 * Purpose : Algorithm for RSA_OAEP with SHA512
 *
 *==========================================================================*/
#ifndef _UCL_RSA_ES_OAEP_SHA512_H_
#define _UCL_RSA_ES_OAEP_SHA512_H_
...
/** @file ucl_pkcs1_es_oaep_sha512.h
 * @defgroup UCL_PKCS1V21_OAEP_SHA512 RSA OAEP SHA512
 * Encrypt/Decrypt with RSA OAEP using the hash function SHA512.
 *
 * @par Header:
 * @link ucl_pkcs1_es_oaep_sha512.h ucl_pkcs1_es_oaep_sha512.h @endlink
 *
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA512 encryption</b>.
 * Encryption complete process using the hash function SHA512.
 *
 ...
 * @see UCL_SHA512
 *
 * @ingroup UCL_PKCS1V21_OAEP_SHA512
 */
int ucl_pkcs1_es_oaep_sha512_encrypt(u8 *output, u8 *input,
                                     u32 input_length, 
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA512 decryption</b>.
 * Decryption complete process using the hash function SHA512.
 *
 ...
 * @ingroup UCL_PKCS1V21_OAEP_SHA512
 */
int ucl_pkcs1_es_oaep_sha512_decrypt(u8 *output, u32 *output_length,
...
/*============================================================================*/
/** <b>RSA-OAEP-SHA512 decryption with CRT</b>.
 * Decryption with CRT complete process using the hash function SHA512.
 *
 * @param[out] output                Pointer to decrypted message
 ...
 * @ingroup UCL_PKCS1V21_OAEP_SHA512
 */
int ucl_pkcs1_es_oaep_sha512_crt_decrypt(u8 *output, u32 *output_length, 
                                         u8 *input, 
...
#endif /* _UCL_RSA_ES_OAEP_SHA512_H_ */
