/*============================================================================
 *
 * ucl_pkcs1_ssa_pkcs1v15_sha512.h
 *
 *==========================================================================*/
/*============================================================================
 *
...
/*============================================================================
 *
 * Purpose : PKCS#1 V2.1 RSASSA-PKCS1V15 with SHA512
 *
 *==========================================================================*/
#ifndef _UCL_RSA_SSA_PKCS1V15_SHA512_H_
#define _UCL_RSA_SSA_PKCS1V15_SHA512_H_
 ...
 *
 * @par Header:
 * @link ucl_pkcs1_ssa_pkcs1v15_sha512.h ucl_pkcs1_ssa_pkcs1v15_sha512.h @endlink
 *
 ...
 * Signature generation using hash function SHA512.
 ...
 * CRT Signature generation using hash function SHA512.
 * it uses pre-hashed data, using the SHA512 function
 *
 * @param[out] signature      The generated signature
 ...
 * Signature verification using hash function SHA512.
 *
...
#endif /*_UCL_RSA_SSA_PKCS1V15_SHA512_H_ */
