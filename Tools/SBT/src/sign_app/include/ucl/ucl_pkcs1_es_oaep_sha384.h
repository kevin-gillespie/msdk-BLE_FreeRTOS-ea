...
/*============================================================================
 *
 * Purpose : Algorithm for RSA_OAEP with SHA384
 *
 *==========================================================================*/
#ifndef _UCL_RSA_ES_OAEP_SHA384_H_
#define _UCL_RSA_ES_OAEP_SHA384_H_
...
/** @file ucl_pkcs1_es_oaep_sha384.h
 * @defgroup UCL_PKCS1V21_OAEP_SHA384 RSA OAEP SHA384
 * Encrypt/Decrypt with RSA OAEP using the hash function SHA384.
 *
 * @par Header:
 * @link ucl_pkcs1_es_oaep_sha384.h ucl_pkcs1_es_oaep_sha384.h @endlink
 *
 ...
 * Decryption complete process using the hash function SHA384.
 *
 ...
 * Decryption with CRT complete process using the hash function SHA384.
 *
 * @param[out] output                Pointer to decrypted message
...
#endif /* _UCL_RSA_ES_OAEP_SHA384_H_ */
