...
/*============================================================================
 *
 * Purpose : PKCS#1 V2.1 RSASSA-PSS with SHA224
 *
 *==========================================================================*/
#ifndef _UCL_RSA_SSA_PSS_SHA224_H_
#define _UCL_RSA_SSA_PSS_SHA224_H_
...
/** @file ucl_pkcs1_ssa_pss_sha224.h
 * @defgroup UCL_PKCS1V21_RSASSAPSS_SHA224 RSASSA-PSS-SHA224
 * RSAPSS with the hash function SHA224.
 *
 * @par Header:
 * @link ucl_pkcs1_ssa_pss_sha224.h ucl_pkcs1_ssa_pss_sha224.h @endlink
 *
 ...
 * Signature generation using the hash function SHA224.
 * the message is hashed using the SHA224 function
 *
 ...
 * Signature generation with CRT using the hash function SHA224.
 * the message is hashed using the SHA224 function
 *
 * @param[out] signature      The generated signature
 * @param[in]  message        The message
...
#endif /*_UCL_RSA_SSA_PSS_SHA224_H_*/
